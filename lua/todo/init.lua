...
function M.setup(opts)
	...
	vim.api.nvim_create_autocmd({ "BufRead", "BufNewFile" }, {
		group = todo_augroup,
		pattern = type(M.config.filenames) == "string" and M.config.filenames or table.concat(M.config.filenames, ","),
		callback = set_maps,
	})
	vim.api.nvim_create_autocmd("FileType", {
		group = todo_augroup,
		pattern = type(M.config.filetypes) == "string" and M.config.filetypes or table.concat(M.config.filetypes, ","),
		callback = set_maps,
	})
end
return M
